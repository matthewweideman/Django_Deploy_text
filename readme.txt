...
> git remote add origin https://github.com/MyGitUserName/myRepoName.git
...
ubuntu@ip-my-ip:~$ git clone https://github.com/MyGitUserName/myRepoName.git
...
DATABASES = {
    'default': {
        ...
        'USER': 'username', # you can put whatever you want here
...
postgres=# CREATE USER MyGitUserName WITH PASSWORD 'passwordYO'; #username is not in quotes, but password is, and both should match what you put into settings.py.
postgres=# GRANT ALL PRIVILEGES ON DATABASE {{projectname}} TO MyGitUserName;
